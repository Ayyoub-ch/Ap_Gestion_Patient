 ...
 */
final class Version20251202131814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chambre (id INT AUTO_INCREMENT NOT NULL, chambre_id INT DEFAULT NULL, etage INT NOT NULL, nombre_lit INT NOT NULL, INDEX IDX_C509E4FF9B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, localite_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, telephone INT NOT NULL, sexe VARCHAR(50) NOT NULL, note VARCHAR(50) NOT NULL, INDEX IDX_1ADAD7EB924DD2B5 (localite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
